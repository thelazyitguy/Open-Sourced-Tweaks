...
- (instancetype)init
{
    ...
    if (self)
	{
        ...
        self.closeTwitterButton = [[UIBarButtonItem alloc] initWithTitle: @"Close Twitter" style: UIBarButtonItemStylePlain target: self action: @selector(closeTwitter)];
        self.closeTwitterButton.tintColor = [UIColor blackColor];
